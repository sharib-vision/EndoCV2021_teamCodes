...
class ValidationLoss(HookBase):
    def __init__(self, cfg):
        ...
        self.__loader = iter(build_detection_train_loader(self.cfg))

    def after_step(self):
        data = next(self.__loader)
        with torch.no_grad():
...
def get_polyp_dicts(data_dirs):
    ...
    base_dir = './trainData_EndoCV2021_2_March2021'
    dataset_dicts = []
            ...
            with open (bbox_filename_full_path) as f:
                ...
                for anno in contents:
                    ...
                    if strings[0] == 'polyp':
                        ...
                        if (x_max - x_min) * (y_max - y_min) < 50 * 50:
...
def setup(args):
    ...
    dir_root = './trainData_EndoCV2021_2_March2021'

    train_data_dirs = ['data_C1', 'data_C2', 'data_C3', 'data_C4', 'data_C5']
    ...
    # cfg.DATASETS.VAL = ("polyp_val",)

    cfg.DATALOADER.NUM_WORKERS = 8
    cfg.INPUT.MASK_FORMAT = 'bitmask'
    cfg.INPUT.FORMAT = 'RGB'
    cfg.OUTPUT_DIR = './mask_rcnn_R_50_FPN_1x_c1_seq_preprocess_small_05/'
    ...
    # cfg.MODEL.WEIGHTS = "https://dl.fbaipublicfiles.com/detectron2/COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x/139653917/model_final_2d9806.pkl"
    # print(cfg.MODEL)
    ...
    cfg.SOLVER.STEPS = ()
    cfg.SOLVER.MAX_ITER = 100000    # 300 iterations 정도면 충분합니다. 더 오랜 시간도 시도해보세요.
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 512   # 풍선 데이터셋과 같이 작은 데이터셋에서는 이정도면 적당합니다.
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 1
    cfg.MODEL.BACKBONE.FREEZE_AT = 0
    cfg.MODEL.RPN.PRE_NMS_TOPK_TRAIN = 40000
...
def main(args):
    ...
    if args.eval_only:
        ...
        model_path = './mask_rcnn_R_50_FPN_1x_c1_seq_preprocess/model_0017999.pth'
